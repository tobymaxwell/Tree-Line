...
Master=read.csv("C:/Users/Paulo/Documents/R/CH2/MasterRW.csv", header=TRUE)
#Basic Ring Width Index calculations
RWI<-detrend(Master,make.plot=TRUE,method=("Spline"),nyrs=NULL, verbose=TRUE)

##### Calculate Master RWI using the C-Method (recomended method, see Biondi and Qeadan, 2008) 

RWI_C<-cms(Master, Master_PO, c.hat.t = FALSE, c.hat.i = FALSE)
...
Master_BAI<-bai.out(rwl=Master,diam=NULL)
Master_BAI
write.csv(Master_BAI, "C:/Users/Paulo/Documents/R/CH2/Master_BAI.csv")
...
library(ggplot2)
library(reshape)
ENSO=read.csv("C:/Users/Paulo/Documents/R/CH2/ENSO.csv", header=TRUE) 
